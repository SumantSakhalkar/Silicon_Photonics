...
load('TMM_3DFDTD.mat');
load('TMM_MODE.mat');
% load('TMM_3DFDTD_normalized.mat');
% load('TMM_MODE_normalized.mat');
...
plot(lambda*1e9, normalize((10*log10(Drop)),'r'),'r');
% legend();
...
legend('MATLAB code normalized','MODE','FDTD');
title('Drop Port');
...
plot(lambda*1e9, normalize((10*log10(Thru)),'r'),'r');
